...
#Region " Public methods "
    ...
    Public Shared Function Init(Optional ByVal width As Integer = -1, _
                                Optional ByVal height As Integer = -1, _
                                Optional ByVal parentControl As Control = Nothing) As Boolean
        ...
        Else
            ...
            If height > -1 Then _OutputRect.Height = width
            _deviceID = 0
    ...
    Public Shared Function PlayVideo() As Boolean
        If _hWnd.Equals(IntPtr.Zero) Then
            _hWnd = capCreateCaptureWindow(_deviceName, WS_VISIBLE Or WS_CHILD, _
                             _OutputRect.Left, _OutputRect.Top, _
                             _OutputRect.Width, _OutputRect.Height, _
                             _hwndParent, 0)
